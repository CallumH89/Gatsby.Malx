...
} from '../components/MoviePoster/MoviePoster';
    ...
    <Layout>
      <MovieHeaderContainer>
        {data.movies.MediaItems.localImage ? (
          <MovieHeader
            loading='lazy'
            fluid={data.movies.MediaItems.localImage.childImageSharp.fluid}
      ...
      <Grid container direction='row' spacing={5}>
        ...
        <Grid item xl={9} lg={9} md={9} sm={9} xs={12}>
          ...
          <P>
            <MovieMeta>Director:</MovieMeta> {data.movies.Director}
          </P>
          <P>
            <MovieMeta>Cast:</MovieMeta> {data.movies.Cast}
          </P>
          <P>
            <MovieMeta>Run Time:</MovieMeta> {data.movies.RunTime} Mins
          </P>
